 ...
 * @method blob                getContraseÃ()       Returns the current record's "ContraseÃ" value
 ...
 * @method Persona             setContraseÃ()       Sets the current record's "ContraseÃ" value
...
abstract class BasePersona extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('ContraseÃ±a', 'blob', 65535, array(
             'type' => 'blob',
             'notnull' => true,
             'length' => 65535,
             ));
